...
instead on per-branch variation. Here, we develop a simple
extension to the Strict Clock model in BEAST2 to
...
and \parencite{???}. Languages function to identify in-groups, and as such they mark social
...
accessible to conscious manipulation \parencite[see][for an extensive discussion]{thomason2007language}.
...
The complete analysis (data, tools to generate the Beast XMLs, Beast XML files,
...
independent of whether evolution a branch is assumed to follow a strict or
relaxed clock.
As our simulation study shows, phylogenetic inference is abe to tease
...
This effect is however not specific to linguistics. In fact, referring to parts
...
adaptations of models developed for biological speciation being applied to
