...
the dated inference of language phylogenies, due to schismogenesis. Three
explanations have been suggested for this phenomenon: Founding Effects,
deliberate/conscious schismogenesis, or correlation of split rate with evolution
rate. As a first step, it should be easy to investigate the question by
...
migration ralanguagetes can differ between different branches of the tree.
