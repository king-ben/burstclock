...
\begin{itemize}
\item ‘Proto-Austronesian (mean of 5,200 y, SD = 300)’, i.\,e. on the root;
...
\begin{itemize}
\item A uniform prior above 5000~yBP (with upper limit 20000~yBP) the MRCA of the non-Bantu Bantoid languages ();
