...
\title{Clocks with bursts: Phylogenetic inference of schismogenesis in lanugage evolution}
\date{\today}
...
implementing this clock. In \cref{sec:simulation}, we show using a simulation
...
\cref{sec:results}. In \cref{sec:discussion}, we discuss the results and formulate our conclusions.
...
mean tree heigh above 5000 years. Following \parencite{brown2018behavior,???}, we cannot
...
schismogenesis, we would expect, in agreement with \authorcite{gray2013three}, a
